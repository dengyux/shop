...
<html>
	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/img/allbg.gif'>
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				<tr bgcolor="#E7E7E7">
					<td height="14" colspan="42" background="<%=path %>/img/wbg.gif">&nbsp;商品管理&nbsp;</td>
				</tr>
				...
				<tr align='center' bgcolor="#FFFFFF">
					...
					<td bgcolor="#FFFFFF" align="center"><div onmouseover = "over('<%=path %>/${goods.fujian}')" onmouseout = "out()" style="cursor:hand;">查看</div></td>
					<td bgcolor="#FFFFFF" align="center">${goods.jiage}</td>
					<td bgcolor="#FFFFFF" align="center">${goods.kucun}</td>
					<td bgcolor="#FFFFFF" align="center">
						<a href="#" onclick="goodsDel(${goods.id})">删除</a>|
