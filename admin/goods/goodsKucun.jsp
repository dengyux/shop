...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body  background='<%=path %>/img/allbg.gif'>
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				<tr bgcolor="#E7E7E7">
					<td height="14" colspan="42" background="<%=path %>/img/wbg.gif">&nbsp;库存查看&nbsp;</td>
				</tr>
				...
				<tr align='center' bgcolor="#FFFFFF">
					...
					<td bgcolor="#FFFFFF" align="center"><font color="red">${goods.kucun}
					   <c:if test="${goods.kucun<=50}">
					     <script>
					       alert("${goods.mingcheng}库存不足，请及时进货！");
					     </script>
					   </c:if>
					</font></td>
