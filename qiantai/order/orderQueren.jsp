									    ...
									    <form action="<%=path %>/buy?type=orderSubmit" name="f" method="post">
					                        <table width="98%" align="center" border="0" cellpadding="9" cellspacing="9">
												...
												<tr align='center'>
												    ...
												    <td width="80%" bgcolor="#FFFFFF" align="left">
												         <input type="text" name="songhuodizhi" value="${sessionScope.user.address}"/>
												    </td>
												</tr>
												<tr align='center'>
												    <td width="20%" bgcolor="#FFFFFF" align="left">
					        				...
					        				<table align="center">
							                   <tr>
							                       <td><a href="#" onclick="back1()"><img border="0" width="100px" height="30px" src="<%=path %>/img/fanhui.jpg"/></a></td>
							                       <td><img border="0"  width="100px" height="30px" src="<%=path %>/img/tijiao.jpg" onclick="javascript:document.f.submit();"/></td>
							                   </tr>
							               </table>
							            </form>
									</TD>
